...
<head>
  ...
  <title>APP La Ceiba | Iniciar Sesión</title>
    ...
    <div class="card-body login-card-body">
      ...
      <form action="?c=auth&a=Login" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="username" placeholder="Usuario" value="<?php echo htmlspecialchars($_POST['username'] ?? ''); ?>" required>
      ...
      <p class="mb-1 text-center mt-3">
        <small class="text-muted">
          Sistema de Gestión de Servicios de Fumigación
        </small>
      </p>
    </div>
    <!-- /.login-card-body -->
